...
MyDocument.getInitialProps = function (ctx) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                sheets = new styles_1.ServerStyleSheets();
                originalRenderPage = ctx.renderPage;
                ctx.renderPage = function () {
                    return originalRenderPage({
                        enhanceApp: function (App) { return function (props) { return sheets.collect(<App {...props}/>); }; },
                    });
                };
            ...
            case 1:
                ...
                return [2 /*return*/, __assign(__assign({}, initialProps), { 
                        ...
                        styles: __spreadArrays(react_1.default.Children.toArray(initialProps.styles), [
